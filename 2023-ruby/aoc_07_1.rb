...
Game = Struct.new(:hand, :bid, :power)
...
def get_hand_power(hand)
  ...
  pp hand
  pp "#{100000000 * get_card_value(hand[0])} #{1000000 * get_card_value(hand[1])} #{10000 * get_card_value(hand[2])} #{100 * get_card_value(hand[3])} #{get_card_value(hand[4])}"
  pp power += 100000000 * get_card_value(hand[0])
  pp power += 1000000   * get_card_value(hand[1])
  pp power += 10000     * get_card_value(hand[2])
  pp power += 100       * get_card_value(hand[3])
  pp power += 1         * get_card_value(hand[4])
